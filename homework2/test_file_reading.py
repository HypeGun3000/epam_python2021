from homework2.file_reading import *


def test_longest_unique_symbols_words():
    assert get_longest_diverse_words("data.txt") == ['kalyptischen', 'Augenblick,', 'Grundmotiv,', 'Evangelium,', 'Deutschland', 'unsterblich', 'vorfindet.', 'Schauspiel', 'Bolschewik', 'Sicherung.']
